...
import { Text, Card, Button, Chip, useTheme, Divider, Badge } from 'react-native-paper';
...
const ActiveOrderItem = ({ order, onPress }) => {
    ...
    <View style={styles.container}>
      ...
      {orders.length === 0 ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <ActiveOrderItem order={item} onPress={handleOrderPress} />
          )}
